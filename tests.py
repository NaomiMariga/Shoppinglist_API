...
class Tests(unittest.TestCase):
    ...
    list = None
    items = None
    registered_email = user.auth_token("abcdefghijklmnopqrstuvwxyz", 10) + "@example.com"
    value = None
    ...
    def test_13_all_functions_return_a_dictionary(self):
        ...
        self.assertIsInstance(user.user_is_logged_in(None, None), dict, " logged_in returns True or False")
        ...
        self.assertIsInstance(user.log_out(None, None), dict, " logout returns a dictionary")
    ...
    def test_06_add_items(self):
        ...
        result3 = shopping.add_items(self.user_id, self.auth_token, self.list["list_id"], "itemName", None, "", None)
    ...
    def test_09_edit_items(self):
        ...
        result4 = shopping.edit_items(self.user_id, self.auth_token, self.items["list_id"], self.items["item_id"], "item_name", "value")
    ...
    def test_12_change_password(self):
            ...
            result8 = user.change_password(self.user_id, self.auth_token, "Password1234", "Password1234")
